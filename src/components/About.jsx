...
const About = () => {
    return (
        <>
            ...
            <img className="ts-about-img-2" src="assets/img/about/about-img-2.png" alt="Restaurant" />
                ...
                <div className="row g-5">
                    ...
                    <div className="ts-about-thumb">
                        ...
                        <div className="ts-about-experience-left mr_10">
                            <img src="assets/img/about/about-circle.png" alt="Restaurant" />
                            <span>50+</span>
                        </div>
                    ...
                    <div className="ts-about-tab">
                        ...
                        <ul className="nav nav-pills mb_25" id="pills-tab" role="tablist">
                        ...
                        <div className="tab-content" id="pills-tabContent">
                            ...
                            <h2 className="ts-about-title mb_15">Exceptional culinary experience and
                                delicious food</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ornare non sed
                                est cursus. Vel hac convallis ipsum, facilisi
                                odio pellentesque bibendum viverra tempus. Lorem ipsum dolor sit amet
                                consectetur adipiscing elit do eiusmod tempor
                                incididunt ut labore et dolore magna minim veniam nostrud exercitation.
                            </p>
                            </div>
                            <div className="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabIndex={0}>
                            <h2 className="ts-about-title mb_15">Exceptional culinary taste and delicious
                                food</h2>
                            <p>Vel hac convallis ipsum, facilisi
                                odio pellentesque bibendum viverra tempus. Lorem ipsum dolor sit amet
                                consectetur adipiscing elit do eiusmod tempor
                                incididunt ut labore et dolore magna minim veniam nostrud exercitation.
                            ...
                            <h2 className="ts-about-title mb_15">Exceptional culinary nice and delicious
                                food</h2>
                            <p>Ornare non sed
                                est cursus. Vel hac convallis ipsum, facilisi
                                odio pellentesque bibendum viverra tempus. Lorem ipsum dolor sit amet
                    ...
                    <div className="ts-about-btn-call mt_32">
                        ...
                        <span><a href="tel:3426739485">+88 3426 739 485</a></span>
                        </div>
                    </div>
                    </div>
                </div>
