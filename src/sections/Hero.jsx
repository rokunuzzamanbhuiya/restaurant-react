            ...
            <div className="container">
                ...
                <div className="row g-5">
                    ...
                    <div className="ts-hero-content mt_100">
                        <h1 className="ts-hero-title">Taste the authentic
                        Saudi cuisine</h1>
                        <p className="ts-hero-paragraph">Among the best Saudi chefs in the world, serving <br /> you
                        something
                        beyond flavor.</p>
                ...
                <img className="ts-hero-shape" src="assets/img/hero/hero-shape.png" alt="Restaurant" />
                <h3 className="ts-hero-text">TODAY <br /> OFFER</h3>
                </div>
            </div>
            </section>
        </>
