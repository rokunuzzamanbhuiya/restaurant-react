            ...
            <div className="row g-lg-5 g-4">
              ...
              <div className="col-xl-3 col-lg-6 col-md-12">
                <div className="tsfooter text-center">
                  <div className="tsfooter__icon mb_22">
                    <img
                      src="assets/img/footer/call-alt.svg"
                      alt="Restaurant"
                    />
                  </div>
                  <div className="tsfooter__content">
        ...
        <div className="ts-footer-bottom text-center mt_134">
          <div className="ts-footer-social mb_35">
            <ul>
              <li>
                <a href="#">
                  <img src="assets/img/footer/facebook.png" alt="Restaurant" />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="assets/img/footer/x.png" alt="Restaurant" />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="assets/img/footer/instagram.png" alt="Restaurant" />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="assets/img/footer/linkedin.png" alt="Restaurant" />
                </a>
              </li>
            </ul>
          </div>
          <div className="ts-footer-text">
            <p>
              © 2024 <a href="#">Niomax</a> All Rights Reserved
            </p>
          </div>
        </div>
      </footer>
